...
class Semantic_Mapping(nn.Module):
    ...
    def forward(self, obs, pose_obs, maps_last, poses_last,agent_states):
        ...
        corrected_pose = pose_obs # overriding with f-param actually
        ...
        # ------------------------------ f-param poses_last, f-param poses_obs
        current_poses = get_new_pose_batch(poses_last, corrected_pose ) ######### FINAL COMPUTATION
